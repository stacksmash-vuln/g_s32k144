...
****************************************************************************/
  ...
  /*
  * @violates @ref GMCLIB_VUnit_h_REF_1 MISRA 2004 Required Rule 19.4, Disallowed definition for macro. 
  * @violates @ref GMCLIB_VUnit_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. 
  * @violates @ref GMCLIB_VUnit_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro parameter 
  ...
  */
  #define GMCLIB_VUnit(...)     macro_dispatcher(GMCLIB_VUnit, __VA_ARGS__)(__VA_ARGS__)     /* This function returns sum of two input parameters. */
    ...
    /*
    * @violates @ref GMCLIB_VUnit_h_REF_1 MISRA 2004 Required Rule 19.4, Disallowed definition for 
    * macro. 
    * @violates @ref GMCLIB_VUnit_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. 
    * @violates @ref GMCLIB_VUnit_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro 
  ...
  * @violates @ref GMCLIB_VUnit_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro parameter 
  * in definition of macro. 
  * @violates @ref GMCLIB_VUnit_h_REF_4 MISRA 2004 Advisory Rule 19.13, #/##' operator used in macro. 
  */

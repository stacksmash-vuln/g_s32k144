...
* 
* @section GMCLIB_Vxy2pol_h_REF_1
* Violates MISRA 2004 Required Rule 19.4, Disallowed definition for macro. 
* To allow the user utilize the benefits of using all three supported implementation of each 
* function in user application, the macro dispatcher inevitably requires use of disallowed macro 
* definition. 
* 
* @section GMCLIB_Vxy2pol_h_REF_2
* Violates MISRA 2004 Advisory Rule 19.7, Function-like macro defined. 
* To allow the user utilize the benefits of using all three supported implementation of each 
* function in user application, the macro dispatcher inevitably requires the function-like macro 
* definition. 
* 
* @section GMCLIB_Vxy2pol_h_REF_3
* Violates MISRA 2004 Required Rule 19.10, Unparenthesized macro parameter in definition of macro. 
* To allow the user utilize the benefits of using all three supported implementation of each 
* function in user application, the macro dispatcher inevitably requires use of unparenthesized 
* macro parameters. 
* 
* @section GMCLIB_Vxy2pol_h_REF_4
* Violates MISRA 2004 Advisory Rule 19.13, #/##' operator used in macro. 
* To allow the user utilize the benefits of using all three supported implementation of each 
* function in user application, the macro dispatcher inevitably requires use of '#/##' operators. 
* 
* @section GMCLIB_Vxy2pol_h_REF_5
...
****************************************************************************/
  ...
  /*
  * @violates @ref GMCLIB_Vxy2pol_h_REF_1 MISRA 2004 Required Rule 19.4, Disallowed definition for macro. 
  * @violates @ref GMCLIB_Vxy2pol_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. 
  * @violates @ref GMCLIB_Vxy2pol_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro parameter 
  ...
  */
  #define GMCLIB_Vxy2pol(...)     macro_dispatcher(GMCLIB_Vxy2pol, __VA_ARGS__)(__VA_ARGS__)     /* This function returns sum of two input parameters. */
    ...
    /*
    * @violates @ref GMCLIB_Vxy2pol_h_REF_1 MISRA 2004 Required Rule 19.4, Disallowed definition for 
    * macro. 
    * @violates @ref GMCLIB_Vxy2pol_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. 
    * @violates @ref GMCLIB_Vxy2pol_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro 
  ...
  * @violates @ref GMCLIB_Vxy2pol_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro parameter 
  * in definition of macro. 
  * @violates @ref GMCLIB_Vxy2pol_h_REF_4 MISRA 2004 Advisory Rule 19.13, #/##' operator used in macro. 
  */

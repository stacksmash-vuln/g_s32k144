...
****************************************************************************/
  ...
  /*
  * @violates @ref MLIB_VAdd_h_REF_1 MISRA 2004 Required Rule 19.4, Disallowed definition for macro. 
  * @violates @ref MLIB_VAdd_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. 
  * @violates @ref MLIB_VAdd_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro parameter 
  ...
  */
  #define MLIB_VAdd(...)     macro_dispatcher(MLIB_VAdd, __VA_ARGS__)(__VA_ARGS__)     /* This function returns sum of two input parameters. */
    ...
    /*
    * @violates @ref MLIB_VAdd_h_REF_1 MISRA 2004 Required Rule 19.4, Disallowed definition for 
    * macro. 
    * @violates @ref MLIB_VAdd_h_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. 
    * @violates @ref MLIB_VAdd_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro 
  ...
  * @violates @ref MLIB_VAdd_h_REF_3 MISRA 2004 Required Rule 19.10, Unparenthesized macro parameter 
  * in definition of macro. 
  * @violates @ref MLIB_VAdd_h_REF_4 MISRA 2004 Advisory Rule 19.13, #/##' operator used in macro. 
  */
...
@param[out]        f32Out     Sum of two input vector.

@param[in]         f32In1     First vector to be add.

@param[in]         f32In2     Second vector to be add.
...
INLINE void MLIB_VAdd_F32(SWLIBS_2Syst_F32 *const f32Out, const SWLIBS_2Syst_F32 *const f32In1, const SWLIBS_2Syst_F32 *const f32In2)
/*
* @violates @ref MLIB_VAdd_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header 
* file. 
*/
{
...
@param[out]        f16Out     Sum of two input vector.

@param[in]         f16In1     First vector to be add.

@param[in]         f16In2     Second vector to be add.
...
INLINE void MLIB_VAdd_F16(SWLIBS_2Syst_F16 *const f16Out, const SWLIBS_2Syst_F16 *const f16In1, const SWLIBS_2Syst_F16 *const f16In2)
/*
* @violates @ref MLIB_VAdd_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header 
* file. 
*/
...
@param[out]        fltOut     Sum of two input vector.

@param[in]         fltIn1     First vector to be add.

@param[in]         fltIn2     Second vector to be add.
...
INLINE void MLIB_VAdd_FLT(SWLIBS_2Syst_FLT *const fltOut, const SWLIBS_2Syst_FLT *const fltIn1, const SWLIBS_2Syst_FLT *const fltIn2)
/*
* @violates @ref MLIB_VAdd_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in header 
* file. 
*/

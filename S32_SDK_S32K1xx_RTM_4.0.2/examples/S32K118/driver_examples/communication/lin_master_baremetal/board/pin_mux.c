...
- pin_list:
  - {pin_num: '52', peripheral: LPUART1, signal: rxd, pin_signal: PTC6, direction: INPUT}
  ...
  - {pin_num: '24', peripheral: PORTD, signal: 'port, 5', pin_signal: PTD5, direction: INPUT, IRQC: state_1010}
  ...
  - {pin_num: '20', peripheral: PORTC, signal: 'port, 3', pin_signal: PTC3, direction: OUTPUT}
  - {pin_num: '36', peripheral: PORTC, signal: 'port, 8', pin_signal: PTC8, direction: INPUT, IRQC: state_1010}
  - {pin_num: '35', peripheral: PORTC, signal: 'port, 9', pin_signal: PTC9, direction: INPUT, IRQC: state_1010}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */

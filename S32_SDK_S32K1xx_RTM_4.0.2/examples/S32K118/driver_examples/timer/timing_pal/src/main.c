...
#define EVB
    ...
    #define LED_RED         16U   /* pin PTD16 - RGB LED on DEV-KIT */
    #define LED_BLUE        8U    /* pin PTE8 - RGB LED on DEV-KIT */
    #define LED_GPIO_PORT1  PTD   /* GPIO PORT D */
    #define LED_GPIO_PORT2  PTE   /* GPIO PORT E */
#else
    #define LED_GREEN       1U    /* pin PTC1 - LED1 on Motherboard */
    #define LED_RED         2U    /* pin PTC2 - LED2 on Motherboard */
    #define LED_BLUE        3U    /* pin PTC3 - LED3 on Motherboard */
    #define LED_GPIO_PORT1  PTC   /* GPIO PORT C */
    #define LED_GPIO_PORT2  PTC   /* GPIO PORT C */
#endif
...
void timingLpitInst0_callback(void * userData)
{
    (void)userData;
    /* Toggle LED_GREEN */
    PINS_DRV_TogglePins(LED_GPIO_PORT1, (1 << LED_GREEN));
}
...
void timingLptmrInst0_callback(void * userData)
{
    (void)userData;
    /* Toggle LED_RED */
    PINS_DRV_TogglePins(LED_GPIO_PORT1, (1 << LED_RED));
}
...
void timingFtmInst0_callback(void * userData)
{
    (void)userData;
    /* Toggle LED_BLUE */
    PINS_DRV_TogglePins(LED_GPIO_PORT2, (1 << LED_BLUE));
}

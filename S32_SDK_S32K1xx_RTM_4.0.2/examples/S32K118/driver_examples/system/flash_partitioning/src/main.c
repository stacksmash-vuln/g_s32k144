...
/* ###################################################################
**     Filename    : main.c
**     Project     : flash_partitioning_s32k118
**     Processor   : s32k118
**     Abstract    :
**         Main module.
...
int main(void)
{
  ...
  /* Write your code here */
    ...
    if (flashSSDConfig.EEESize == 0u)
    {
         ...
         * and FlexNVM Partition Code. For example on S32K118:
         * - EEEDataSizeCode = 0x03u: EEPROM size = 2 Kbytes
         * - DEPartitionCode = 0x09u: EEPROM backup size = 24 Kbytes */
        ret = FLASH_DRV_DEFlashPartition(&flashSSDConfig, 0x03u, 0x09u, 0x0u, false, true);
        DEV_ASSERT(STATUS_SUCCESS == ret);

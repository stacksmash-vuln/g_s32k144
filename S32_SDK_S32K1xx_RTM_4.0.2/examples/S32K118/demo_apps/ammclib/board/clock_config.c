...
- {id: LPTMR0_CLK.outFreq, value: 48 MHz}
- {id: LPUART0_CLK.outFreq, value: 48 MHz}
...
- {id: PCC.LPTMR0_CLK_SEL.sel, value: SCG.FIRCDIV2_CLK}
- {id: PCC.LPTMR0_FRAC.scale, value: '1', locked: true}
- {id: PCC.LPUART0_CLK_SEL.sel, value: SCG.FIRCDIV2_CLK}

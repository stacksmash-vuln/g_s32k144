...
- pin_list:
  ...
  - {pin_num: '29', peripheral: PORTD, signal: 'port, 15', pin_signal: PTD15, direction: INPUT}
  - {pin_num: '28', peripheral: PORTD, signal: 'port, 16', pin_signal: PTD16, direction: INPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */

...
#ifdef EVB
    #define LED_BLUE        23U     /* pin PTE23 - RGB LED on DEV-KIT */
    #define LED_RED         21U     /* pin PTE21 - RGB LED on DEV-KIT */
    #define LED_GREEN       22U     /* pin PTE22 - RGB LED on DEV-KIT */
    #define LED_GPIO_PORT   PTE     /* GPIO PORT E */
#else
    #define LED_BLUE        0U      /* pin PTC0 - LED0 on Mother board */
    #define LED_RED         1U      /* pin PTC1 - LED1 on Mother board */
    #define LED_GREEN       2U      /* pin PTC2 - LED2 on Mother board */

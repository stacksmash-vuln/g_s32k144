...
- {pin_num: '128', pin_signal: PTE21, label: led0_evb, identifier: led0_evb}
- {pin_num: '129', pin_signal: PTE22, label: led1_evb, identifier: led1_evb}
- {pin_num: '53', pin_signal: PTC0, label: led0_mb, identifier: led0_mb}
- {pin_num: '52', pin_signal: PTC1, label: led1_mb, identifier: led1_mb}

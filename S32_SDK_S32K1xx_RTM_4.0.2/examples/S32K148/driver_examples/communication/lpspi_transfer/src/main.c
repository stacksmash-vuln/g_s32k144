...
int main(void)
{
    ...
    /* Example Description
     * Potentiometer voltage is read using ADC0- channel 28. The value is send to
     * LPSPI1 from LPSPI0. The read value represent duty for PWM (FTM4-channel 1).
     */
    ...
    while(1)
    {
        ...
        FTM_DRV_UpdatePwmChannel(INST_FLEXTIMER_PWM_1, 1U, FTM_PWM_UPDATE_IN_DUTY_CYCLE, masterDataReceive<<8, 0U, true);
    }

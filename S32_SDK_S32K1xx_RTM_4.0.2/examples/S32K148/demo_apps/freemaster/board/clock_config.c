...
- {id: QSPI0_CLK.outFreq, value: 24 MHz}
- {id: QSPI0_MODULE_CLK.outFreq, value: 24 MHz}
...
- {id: FTM4_CGC, value: Disabled}
- {id: FTM5_CGC, value: Disabled}
- {id: FTM6_CGC, value: Disabled}
- {id: FTM7_CGC, value: Disabled}
...
- {id: SAI0_CGC, value: Disabled}
- {id: SAI1_CGC, value: Disabled}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    ...
    .simConfig =
    {
        ...
        .tclkConfig =
        {
            ...
            .extPinSrc[4] = 0U, /*!< FTM4 ext pin source   */
            .extPinSrc[5] = 0U, /*!< FTM5 ext pin source   */
            .extPinSrc[6] = 0U, /*!< FTM6 ext pin source   */
            .extPinSrc[7] = 0U, /*!< FTM7 ext pin source   */
        },
        .traceClockConfig =
        {
            .initialize = true, /*!< Initialize    */

...
pin_labels:
- {pin_num: '21', pin_signal: PTD16, label: LED_RED, identifier: LED_RED}
- {pin_num: '22', pin_signal: PTD15, label: LED_GREEN, identifier: LED_GREEN}
...
- pin_list:
  - {pin_num: '72', peripheral: EWM, signal: in, pin_signal: PTA3}

...
pin_labels:
- {pin_num: '74', pin_signal: PTB11, label: Button1, identifier: Button1}
- {pin_num: '68', pin_signal: PTB12, label: Button2, identifier: Button2}
- {pin_num: '40', pin_signal: PTC0, label: LED0, identifier: LED0}
- {pin_num: '39', pin_signal: PTC1, label: LED0, identifier: LED1;LED0}
- {pin_num: '30', pin_signal: PTC2, label: LED1, identifier: LED2;LED1}
- {pin_num: '54', pin_signal: PTB0, label: Button1, identifier: Button1}
- {pin_num: '53', pin_signal: PTB1, label: Button2, identifier: Button2}
- {pin_num: '3', pin_signal: PTD1, label: LED0, identifier: LED0}
- {pin_num: '71', pin_signal: PTD2, label: LED1, identifier: LED1}
- {pin_num: '70', pin_signal: PTD3, label: LED2, identifier: LED2}

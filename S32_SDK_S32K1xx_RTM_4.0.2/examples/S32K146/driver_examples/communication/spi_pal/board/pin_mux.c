...
pin_labels:
- {pin_num: '78', pin_signal: PTB0, label: PCS1, identifier: PCS1}
- {pin_num: '68', pin_signal: PTB2, label: SCK1, identifier: SCK1}
- {pin_num: '63', pin_signal: PTB3, label: SIN1, identifier: SIN1}
- {pin_num: '29', pin_signal: PTD15, label: PTD15, identifier: PTD15}
- {pin_num: '77', pin_signal: PTB1, label: SOUT1, identifier: SOUT1}

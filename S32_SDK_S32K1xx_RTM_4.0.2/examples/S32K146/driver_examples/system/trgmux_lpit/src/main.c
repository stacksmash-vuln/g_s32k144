...
/*!
 * @brief: PINS Interrupt Handler.
 *         When the button is pushed and an interrupt occurs clear the interrupt flag
 *         and generate a software trigger
 */
void PINS_ISR(void)
{
...
int main(void)
{
  /* Write your code here */
    ...
    INT_SYS_InstallHandler(PORTC_IRQn,&PINS_ISR,(isr_t *)0 );

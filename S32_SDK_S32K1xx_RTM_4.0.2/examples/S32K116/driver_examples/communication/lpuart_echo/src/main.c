...
int main(void)
{
  ...
  LPUART_DRV_Init(INST_LPUART_LPUART_0, &lpUartState0, &lpUartInitConfig0);
  /* Install the callback for rx events */
  LPUART_DRV_InstallRxCallback(INST_LPUART_LPUART_0, rxCallback, NULL);
  /* Send a welcome message */
  LPUART_DRV_SendDataBlocking(INST_LPUART_LPUART_0, (uint8_t *)welcomeMsg, strlen(welcomeMsg), TIMEOUT);

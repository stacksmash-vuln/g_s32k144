...
/* ###################################################################
**     Filename    : main.c
**     Project     : lin_slave_baremetal_s32k116
...
#else
    #define PORT_LED0_INDEX           (1u)
    #define PORT_LED1_INDEX           (2u)
    #define PORT_LED2_INDEX           (3u)
    #define PORT_LED0_MASK            (0x1u << PORT_LED0_INDEX)
    #define PORT_LED1_MASK            (0x1u << PORT_LED1_INDEX)
    #define PORT_LED2_MASK            (0x1u << PORT_LED2_INDEX)
    #define LED_GPIO_PORT             (PTC)
    #define PORT_BTN0_INDEX           (8u)
    #define PORT_BTN1_INDEX           (9u)
    #define PORT_BTN0_MASK            (0x1u << PORT_BTN0_INDEX)
    #define PORT_BTN1_MASK            (0x1u << PORT_BTN1_INDEX)
...
void RXPIN_IRQHandler(void)
{
    ...
    if(PINS_DRV_GetPortIntFlag(PORTC) & (1U << 6U))
    {
...
int main(void)
{
  /* Write your local variable definition here */
    ...
    INT_SYS_InstallHandler(BTN_PORT_IRQn, RXPIN_IRQHandler, (isr_t *)NULL);

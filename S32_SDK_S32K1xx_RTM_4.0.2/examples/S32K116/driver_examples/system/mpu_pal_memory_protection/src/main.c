...
/* ###################################################################
**     Filename    : main.c
**     Project     : mpu_pal_memory_protection_s32k116
**     Processor   : S32K116_48
**     Version     : Driver 01.00
**     Compiler    : GNU C Compiler
**     Date/Time   : 2020-05-08, 12:00, # CodeGen: 0
**     Abstract    :
**         Main module.
...
#define EVB
    ...
    #define LED_RED         16U        /* pin PTD16 - LED RGB on DEV-KIT */
    #define LED_GREEN       15U        /* pin PTD15 - LED RGB on DEV-KIT */
    #define SW_GPIO         PTD        /* SW GPIO type */
    #define SW              3U         /* pin PTD3 - SW2_BTN0 on DEV-KIT */
#else
    #define ON              0U         /* LED ON */
    #define OFF             1U         /* LED OFF */
    #define LED_GPIO        PTC        /* LED GPIO type */
    #define LED_RED         1U         /* pin PTC1 - LED1 on Motherboard */
    #define LED_GREEN       2U         /* pin PTC2 - LED2 on Motherboard */
    #define SW_GPIO         PTC        /* SW GPIO type */
    #define SW              8U         /* pin PTC8 - SW2_BTN0 on Motherboard */
#endif

/* Protected address in Flash memory */
#define ADDRESS_PROTECT     0x0001FF04U

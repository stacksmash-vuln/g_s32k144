...
#ifdef EVB
    #define LED0            16U /* pin PTD16 - LED RED of LED RGB on DEV-KIT    */
    #define LED1            15U /* pin PTD15 - LED GREEN of LED RGB on DEV-KIT  */
    #define LED_GPIO        PTD /* LED GPIO type                                */
    #define SW              3U  /* pin PTD3 - SW2_BTN0 on DEV-KIT               */
    #define SW_GPIO         PTD /* SW GPIO type                                 */
#else
    #define LED0            1U  /* pin PTC1 - LED0 on Motherboard               */
    #define LED1            2U  /* pin PTC2 - LED1 on Motherboard               */
    #define LED_GPIO        PTC /* LED GPIO type                                */
    #define SW              8U  /* pin PTC8 - BTN0 on Motherboard               */

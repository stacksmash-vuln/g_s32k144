...
/* ###################################################################
**     Filename    : main.c
**     Project     : power_mode_switch_s32k116
...
void ButtonISR(void)
{
    ...
    PINS_DRV_WritePin(LED_PORT, GREEN_LED, ON);
    /* Board EVB - red led on */
    PINS_DRV_WritePin(LED_PORT, RED_LED, OFF);
}
...
int main(void)
{
    ...
    INT_SYS_InstallHandler(PORT_IRQn, ButtonISR, (isr_t *)0);
    ...
    while(1)
    {
        ...
        case '1':
            ...
            if (retV == STATUS_SUCCESS)
            {
                ...
                (void)CLOCK_SYS_GetFreq(CORE_CLK, &frequency);
        ...
        case '3':
            ...
            /* Board EVB - green led on */
            PINS_DRV_WritePin(LED_PORT, GREEN_LED, OFF);
            /* Board EVB - red led off */
            PINS_DRV_WritePin(LED_PORT, RED_LED, ON);

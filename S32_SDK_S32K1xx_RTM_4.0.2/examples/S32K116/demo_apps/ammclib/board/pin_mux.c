...
- pin_list:
  ...
  - {pin_num: '10', peripheral: FTM0, signal: 'ch, 1', pin_signal: PTD16, direction: OUTPUT}
  - {pin_num: '13', peripheral: FTM0, signal: 'ch, 6', pin_signal: PTE8}
  - {pin_num: '25', peripheral: LPUART0, signal: txd, pin_signal: PTB1}

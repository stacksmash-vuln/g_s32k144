...
- name: BOARD_InitPeripherals
  UUID: 20a57540-ab82-4e46-95f7-544b01de31a6
...
- config_sets:
  - spi_pal:
    - spi_palMasterConfig:
      - 0:
        - name: 'LPSPI_1_MasterInitConfig0'
        - baudRate: '500000'
        - frameSize: '8'
...
spi_master_t LPSPI_1_MasterInitConfig0 =
{
    .baudRate         = 500000U,
    .frameSize        = 8U,
    .bitOrder         = SPI_TRANSFER_MSB_FIRST,
...
spi_slave_t LPSPI_1_SlaveInitConfig0 =
{
    .frameSize        = 8U,
    .bitOrder         = SPI_TRANSFER_MSB_FIRST,
    .clockPolarity    = SPI_ACTIVE_HIGH,

...
- {id: BUS_CLK.outFreq, value: 64/9 MHz}
- {id: CLKOUT.outFreq, value: 48 MHz}
- {id: CMP0_CLK.outFreq, value: 64/9 MHz}
- {id: CORE_CLK.outFreq, value: 64 MHz}
- {id: CRC0_CLK.outFreq, value: 64/9 MHz}
- {id: DMA0_CLK.outFreq, value: 64 MHz}
- {id: DMAMUX0_CLK.outFreq, value: 64/9 MHz}
- {id: EIM0_CLK.outFreq, value: 64 MHz}
- {id: ERM0_CLK.outFreq, value: 64 MHz}
- {id: EWM0_CLK.outFreq, value: 64/9 MHz}
- {id: FIRCDIV1_CLK.outFreq, value: 48 MHz}
- {id: FIRCDIV2_CLK.outFreq, value: 48 MHz}
- {id: FLASH_CLK.outFreq, value: 12.8 MHz}
- {id: FLEXCAN0_CLK.outFreq, value: 64 MHz}
- {id: FLEXCAN1_CLK.outFreq, value: 64 MHz}
- {id: FTFM0_CLK.outFreq, value: 12.8 MHz}
...
- {id: MPU0_CLK.outFreq, value: 64 MHz}
- {id: MSCM0_CLK.outFreq, value: 64 MHz}
- {id: PDB0_CLK.outFreq, value: 64 MHz}
- {id: PDB1_CLK.outFreq, value: 64 MHz}
- {id: PORTA_CLK.outFreq, value: 64/9 MHz}
- {id: PORTB_CLK.outFreq, value: 64/9 MHz}
- {id: PORTC_CLK.outFreq, value: 64/9 MHz}
- {id: PORTD_CLK.outFreq, value: 64/9 MHz}
- {id: PORTE_CLK.outFreq, value: 64/9 MHz}
- {id: RTC0_CLK.outFreq, value: 64/9 MHz}
...
- {id: SPLLDIV1_CLK.outFreq, value: 64 MHz}
- {id: SPLLDIV2_CLK.outFreq, value: 8 MHz}
- {id: SPLL_CLK_OUT.outFreq, value: 128 MHz}
- {id: SYS_CLK.outFreq, value: 64 MHz}
- {id: TRACE_CLK.outFreq, value: 64 MHz}
settings:
- {id: PCC.FlexIO0_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: PCC.LPI2C0_CLK_SEL.sel, value: SCG.SPLLDIV2_CLK}
- {id: 'RUN:SCG.DIVBUS.scale', value: '9', locked: true}
- {id: 'RUN:SCG.DIVCORE.scale', value: '2', locked: true}
- {id: 'RUN:SCG.DIVSLOW.scale', value: '5', locked: true}
- {id: 'RUN:SCG.SCSSEL.sel', value: SCG.SPLL_CLK}
- {id: SCG.DIVBUS.scale, value: '9', locked: true}
...
- {id: SCG.SPLL_mul.scale, value: '32'}
...
clock_manager_user_config_t clockMan1_InitConfig0 = {
    .scgConfig =
    {
        ...
        .spllConfig =
        {
            ...
            .mult = (uint8_t)SCG_SPLL_CLOCK_MULTIPLY_BY_32,/* Multiply Factor is 32 */
            .src = 0U,
            .div1 = SCG_ASYNC_CLOCK_DIV_BY_2,     /* System PLL Clock Divider 1: divided by 2 */
            .div2 = SCG_ASYNC_CLOCK_DIV_BY_16,    /* System PLL Clock Divider 3: divided by 16 */
        },
        .clockOutConfig =
        {
            .initialize = true,
        ...
        .clockModeConfig =
        {
            ...
            .rccrConfig =
            {
                ...
                .divBus = SCG_SYSTEM_CLOCK_DIV_BY_9,/* Bus Clock Divider: divided by 9 */
                .divSlow = SCG_SYSTEM_CLOCK_DIV_BY_5,/* Slow Clock Divider: divided by 5 */
            },
            .vccrConfig =
            {

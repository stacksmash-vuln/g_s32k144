 ...
 * Included files 
 ******************************************************************************/
#include "peripherals_uart_pal_FLEXIO.h"

/*******************************************************************************
 * uart_pal_FLEXIO initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
- name: 'uart_pal_FLEXIO'
...
- config_sets:
  - uart_pal:
    - uartPalInst:
      - name: 'uart_instance_fi0'
      - readonly: 'false'
      - instType: 'UART_INST_TYPE_FLEXIO_UART'
    - uartCfgArray:
      - 0:
        - uartCommonConfig:
          - name: 'FLEXIO_uart_pal_config0'
          - readonly: 'true'
          - baudRate: '9600'
...
uart_instance_t uart_instance_fi0 = {
  .instType = UART_INST_TYPE_FLEXIO_UART,
  .instIdx = 0
};

static extension_flexio_for_uart_t uart_ext0 = {
  .dataPinTx = 1U,
  .dataPinRx = 0U
};

const uart_user_config_t FLEXIO_uart_pal_config0 = {
  .baudRate = 9600UL,
  .parityMode = UART_PARITY_DISABLED,
  .bitCount = UART_8_BITS_PER_CHAR,
  .stopBitCount = UART_ONE_STOP_BIT,

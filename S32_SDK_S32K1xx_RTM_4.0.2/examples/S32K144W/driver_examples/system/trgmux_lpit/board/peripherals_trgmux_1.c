...
- name: BOARD_InitPeripherals
  UUID: c48ae6ec-1459-41ff-b6c3-4c8ba33b3f0f
  ...
  - trgmux:
    - trgmuxCfg:
      - 0:
        ...
        - mapping_cfg:
          - 0:
            - triggerSource: 'TRGMUX_TRIG_SOURCE_TRGMUX_IN5'
            - targetModule: 'TRGMUX_TARGET_MODULE_LPIT_TRG_CH1'
            - lockreg: 'false'
          - 1:
            - triggerSource: 'TRGMUX_TRIG_SOURCE_TRGMUX_IN3'
...
{
    {TRGMUX_TRIG_SOURCE_TRGMUX_IN5, TRGMUX_TARGET_MODULE_LPIT_TRG_CH1, false},
    {TRGMUX_TRIG_SOURCE_TRGMUX_IN3, TRGMUX_TARGET_MODULE_LPIT_TRG_CH0, false},
};

...
#ifdef EVB
  /* LPIT channel used */
  #define LPIT_CHANNEL        1UL
  #define LPIT_Channel_IRQn   LPIT0_Ch1_IRQn
  /* Led blink */
  #define LED_PIN             7U
  #define LED_GPIO            PTE
#else
...
#ifdef EVB
    LPIT_DRV_InitChannel(INST_LPIT_CONFIG_1, LPIT_CHANNEL, &lpit1_ChnConfig1);
#else

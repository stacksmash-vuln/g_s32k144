...
/* ###################################################################
**     Filename    : main.c
**     Project     : flash_partitioning_s32k144w
**     Processor   : s32k144w
**     Abstract    :
**         Main module.
...
int main(void)
{
  ...
  /* Write your code here */
    ...
    {
#ifndef FLASH_TARGET
        /* Make FlexRAM used as traditional RAM at the fisrt time */
         ...
         * and FlexNVM Partition Code. For example on S32K144W:

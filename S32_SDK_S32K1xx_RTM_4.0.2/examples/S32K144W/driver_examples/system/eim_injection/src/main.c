...
/* ###################################################################
**     Filename    : main.c
**     Project     : eim_injection_s32k144w
...
#ifdef EVB
    #define LED0            7U  /* pin PTE7 - LED RED of LED RGB on DEV-KIT    */
    #define LED1            0U  /* pin PTE0 - LED GREEN of LED RGB on DEV-KIT  */
    #define LED_GPIO        PTE /* LED GPIO type */
    #define SW              2U  /* pin PTD2 - SW2_BTN0 on DEV-KIT              */
    #define SW_GPIO         PTD /* SW GPIO type                                 */
#else
    #define LED0            0U  /* pin PTC0 - LED0 on S32K-MB        */
    #define LED1            1U  /* pin PTC1 - LED1 on S32K-MB        */
    #define LED_GPIO        PTC /* LED GPIO type                      */
    #define SW              12U /* pin PTB12 - BUTTON0 on on S32K-MB  */

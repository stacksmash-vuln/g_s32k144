        ...
        - FtmPwmConfigArr:
          ...
          - ftmPwmCombChnCfg:
            - pwmCombinedChannelConfig:
              - 0:
                - ftmPwmCombName: 'flexTimer_pwm_1_CombinedChannelConfig0'
                - ftmPwmCombHwChnId: '0'
                - firstEdge: '0'
                - secondEdge: '0'
                - CombDeadTimeEn: 'false'
                - enableModifiedCombine: 'true'
                - mainChannelPolarity: 'FTM_POLARITY_HIGH'
                - enCombSecondChannelOutput: 'true'
                - secondCombChannelPolarity: 'FTM_MAIN_INVERTED'
                - enCombExternalTrigger: 'false'
                - enCombExternalTriggerOnNextChn: 'false'
                - mainChannelSafeState: 'FTM_LOW_STATE'
                - secondChannelSafeState: 'FTM_LOW_STATE'
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
/* clang-format on */
...
/* The combined channels configuration structure for  flexTimer_pwm_1CombinedChannelsConfig */
ftm_combined_ch_param_t flexTimer_pwm_1_CombinedChannelsConfig[1] =
{
    {
        0, /* Hardware channel for channel (n) */
        0U, /* First edge time */
        0U, /* Second edge time */

...
- name: BOARD_InitPeripherals
  UUID: 65f6a7c2-ccc1-4637-8136-24452fa547d6
 ...
 * Included files 
 ******************************************************************************/
#include "peripherals_mpu_pal1.h"

/*******************************************************************************
 * mpu_pal1 initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
...
- config_sets:
  - mpu_pal_s32k:
    - mpu_pal_Configuration:
      - mpu_pal_UserConfig:
        - 0:
          - name: 'mpu_pal1_RegionConfig0'
          - readOnly: 'true'
          - mpu_pal_RegionConfig:
            - 0:
              - startAddr: '0x0'
              - endAddr: '0xFFFFFFFF'
              - masterAccRight: 'mpu_pal1_AccessRightConfig0'
              - processIdentifier: '0x0'
              - processIdMask: '0x0'
            - 1:
              - startAddr: '0x0'
              - endAddr: '0x3FEFF'
              - masterAccRight: 'mpu_pal1_AccessRightConfig1'
              - processIdentifier: '0x0'
              - processIdMask: '0x0'
            - 2:
              - startAddr: '0x3FF00'
              - endAddr: '0x3FF1F'
              - masterAccRight: 'mpu_pal1_AccessRightConfig2'
              - processIdentifier: '0x0'
              - processIdMask: '0x0'
            - 3:
              - startAddr: '0x3FF00'
              - endAddr: '0x3FF1F'
              - masterAccRight: 'mpu_pal1_AccessRightConfig3'
              - processIdentifier: '0x0'
              - processIdMask: '0x0'
            - 4:
              - startAddr: '0x3FF20'
      ...
      - mpu_pal_MasterConfig:
        - 0:
          - name: 'mpu_pal1_AccessRightConfig0'
          - readOnly: 'true'
          - mpu_pal_Master:
            - 0:
            ...
            - 2:
              ...
              - pidEnable: 'false'
        - 1:
          - name: 'mpu_pal1_AccessRightConfig1'
          - readOnly: 'true'
          - mpu_pal_Master:
            - 0:
              - masterNum: 'FEATURE_MPU_MASTER_CORE'
            ...
            - 2:
              ...
              - pidEnable: 'false'
        - 2:
          - name: 'mpu_pal1_AccessRightConfig2'
          - readOnly: 'true'
          - mpu_pal_Master:
            - 0:
              - masterNum: 'FEATURE_MPU_MASTER_CORE'
            ...
            - 2:
              ...
              - pidEnable: 'false'
        - 3:
          - name: 'mpu_pal1_AccessRightConfig3'
          - readOnly: 'true'
          - mpu_pal_Master:
            - 0:
              - masterNum: 'FEATURE_MPU_MASTER_CORE'
...
const mpu_master_access_permission_t mpu_pal1_AccessRightConfig3[] = {
    {
        .masterNum = FEATURE_MPU_MASTER_CORE,

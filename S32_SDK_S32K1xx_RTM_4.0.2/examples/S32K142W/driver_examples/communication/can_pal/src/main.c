...
/* ###################################################################
**     Filename    : main.c
**     Project     : can_pal_s32k142w
**     Processor   : S32K142W_64
**     Version     : Driver 01.00
**     Compiler    : GNU C Compiler
**     Date/Time   : 2020-05-01, 11:48, # CodeGen: 2
**     Abstract    :
**         Main module.
...
void buttonISR(void)
{
    ...
    if(buttonsPressed != 0)
    {
        ...
        if (sendFrame)
        {
            ...
            CAN_ConfigTxBuff(&can_instance0, TX_MAILBOX, &buffCfg);
            ...
            CAN_Send(&can_instance0, TX_MAILBOX, &message);
        }
    }
}

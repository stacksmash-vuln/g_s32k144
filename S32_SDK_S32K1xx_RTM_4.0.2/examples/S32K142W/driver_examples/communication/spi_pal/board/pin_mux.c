...
- {pin_num: '14', pin_signal: PTD16, label: SIN0, identifier: SIN0}
- {pin_num: '15', pin_signal: PTD15, label: SCK0, identifier: SCK0}
- {pin_num: '18', pin_signal: PTB5, label: PCS0, identifier: PCS0}
- {pin_num: '19', pin_signal: PTB4, label: SOUT0, identifier: SOUT0}
- {pin_num: '45', pin_signal: PTD3, label: PCS1, identifier: PCS1}
- {pin_num: '46', pin_signal: PTD2, label: SOUT1, identifier: SOUT1}
- {pin_num: '39', pin_signal: PTE7, label: LED, identifier: LED}

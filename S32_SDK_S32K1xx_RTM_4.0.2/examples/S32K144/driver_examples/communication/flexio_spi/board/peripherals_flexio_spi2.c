...
- name: BOARD_InitPeripherals
  UUID: 43c7cb10-917a-452a-b27b-cf199c8999ac
 ...
 * Included files 
 ******************************************************************************/
#include "peripherals_flexio_spi2.h"

/*******************************************************************************
 * flexio_spi2 initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
...
- config_sets:
  - flexio_spi_driver:
    - flexio_spi_master_Configuration:
      - 0:
        - name: 'flexio_spi2_MasterConfig0'
        - readonly: 'true'
        - baudRate: '100000'
...
const flexio_spi_master_user_config_t flexio_spi2_MasterConfig0 = {
  .baudRate = 100000UL,
  .driverType = FLEXIO_DRIVER_TYPE_INTERRUPTS,
  .bitOrder = FLEXIO_SPI_TRANSFER_MSB_FIRST,
  .transferSize = FLEXIO_SPI_TRANSFER_1BYTE,

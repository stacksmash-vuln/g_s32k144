...
- {pin_num: '24', pin_signal: PTD14, label: LED_BLUE, identifier: LED_BLUE}
...
- pin_list:
  ...
  - {pin_num: '22', peripheral: PORTD, signal: 'port, 15', pin_signal: PTD15, direction: OUTPUT, ISF: state_0, DSE: state_1, initValue: state_1}
  - {pin_num: '21', peripheral: PORTD, signal: 'port, 16', pin_signal: PTD16, direction: OUTPUT, DSE: state_1, initValue: state_1}
  - {pin_num: '24', peripheral: PORTD, signal: 'port, 14', pin_signal: PTD14, direction: OUTPUT, initValue: state_1}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */

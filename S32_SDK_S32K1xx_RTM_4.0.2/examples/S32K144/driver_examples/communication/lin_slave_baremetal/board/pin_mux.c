...
- pin_list:
  - {pin_num: '32', peripheral: LPUART2, signal: rxd, pin_signal: PTD6, direction: INPUT}
  ...
  - {pin_num: '66', peripheral: PORTB, signal: 'port, 14', pin_signal: PTB14, direction: OUTPUT}
  - {pin_num: '65', peripheral: PORTB, signal: 'port, 15', pin_signal: PTB15, direction: OUTPUT}
  - {pin_num: '64', peripheral: PORTB, signal: 'port, 16', pin_signal: PTB16, direction: OUTPUT}

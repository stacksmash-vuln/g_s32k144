...
- name: BOARD_InitPeripherals
  UUID: 5f4bdab7-7cb1-49a9-ae30-dc43d0cdc266
  ...
  - power_manager:
    - POWER_CONFIGURATIONS:
      - powerModeConfiguration:
        ...
        - 1:
          - powerModeConfig: 'pwrMan1_InitConfig1'
          - sleepOnExitValue: 'false'
          - powerMode: 'POWER_MANAGER_RUN'
        - 2:
          - powerModeConfig: 'pwrMan1_InitConfig2'
          - sleepOnExitValue: 'false'
          - powerMode: 'POWER_MANAGER_VLPR'
        - 3:
          - powerModeConfig: 'pwrMan1_InitConfig3'
          - sleepOnExitValue: 'false'
          - powerMode: 'POWER_MANAGER_STOP1'
        - 4:
          - powerModeConfig: 'pwrMan1_InitConfig4'
          - sleepOnExitValue: 'false'
          - powerMode: 'POWER_MANAGER_STOP2'
        - 5:
          - powerModeConfig: 'pwrMan1_InitConfig5'
          - sleepOnExitValue: 'false'

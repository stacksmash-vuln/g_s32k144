...
- {pin_num: '50', pin_signal: PTC12, label: BTN0, identifier: BUTTON0;SW2}
...
- pin_list:
  ...
  - {pin_num: '50', peripheral: PORTC, signal: 'port, 12', pin_signal: PTC12, identifier: SW2, direction: INPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */

...
var HwAbstr = {
 ...
 /**
  ...
  PccClockDesciption: {
    ...
    "pccFTM4Clk" :    ["FTM4_CLK","PCC::FTM4","FTM4"],
    "pccFTM5Clk" :    ["FTM5_CLK","PCC::FTM5","FTM5"],
    "pccFTM6Clk" :    ["FTM6_CLK","PCC::FTM6","FTM6"],
    "pccFTM7Clk" :    ["FTM7_CLK","PCC::FTM7","FTM7"],
    "pccENET0Clk" :    ["ENET0_CLK","PCC::ENET","ENET0"],
    ...
    "pccSAI0Clk" :    ["SAI0_CLK","PCC::SAI0","SAI0"],
    "pccSAI1Clk" :    ["SAI1_CLK","PCC::SAI1","SAI1"],
    "pccQSPI0Clk" :    ["QSPI0_CLK","PCC::QSPI","QSPI0"],
    "pccFlexCAN0Clk" :    ["FlexCAN0_CLK","PCC::FlexCAN0","FLEXCAN0"],
    "pccFlexCAN1Clk" :    ["FlexCAN1_CLK","PCC::FlexCAN1","FLEXCAN1"],
    "pccFlexCAN2Clk" :    ["FlexCAN2_CLK","PCC::FlexCAN2","FLEXCAN2"],
    ...
    PccClockIpFrac: {
   keyFunc : (function (cfg,register) { return (register.indexOf("LPTMR")==-1 && register.indexOf("ENET")==-1)?0:cfg.getBitFieldValueAsBigInteger(register,"FRAC"); }),
   enumMap:[
    ...
    PccClockIpDiv: {
   keyFunc : (function (cfg,register) { return (register.indexOf("LPTMR")==-1 && register.indexOf("ENET")==-1)?0:cfg.getBitFieldValueAsBigInteger(register,"PCD"); }),
   enumMap:[

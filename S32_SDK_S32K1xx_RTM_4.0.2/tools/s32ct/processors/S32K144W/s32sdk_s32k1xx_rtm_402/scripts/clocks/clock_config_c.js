...
for (elementId in HwAbstr.PccClockDesciption){
    if (HwAbstr.clockElementExist(cfg, elementId)) {
        if (HwAbstr.isClockElementUsed(cfg, elementId)) {
            ...
            if (regPCC.indexOf("PORT") == -1 && regPCC.indexOf("EWM") == -1 && regPCC.indexOf("CMP") == -1 && regPCC.indexOf("CRC") == -1 && regPCC.indexOf("DMA") == -1 && regPCC.indexOf("FTFM") == -1 && regPCC.indexOf("FlexCAN") == -1 && regPCC.indexOf("PDB") == -1 && regPCC.indexOf("RTC") == -1)
            {
